...
const char* ssid = "aquí o nome da rede";
const char* password = "aquí o seu contrasinal";

// Initialize Telegram BOT
#define BOTtoken "17XXXXX563:AAG4kMA00jJ_jXXXXl-E1O0UJTkaaHVFWvw"  // o teu token de bot (obtén de Botfather) 
